        ...
        redChallenges.forEach { description ->
            challenges.add(
                Challenge(
                    ...
                    category = context.getString(R.string.category_red),
        ...
        blueChallenges.forEach { description ->
            challenges.add(
                Challenge(
                    ...
                    category = context.getString(R.string.category_blue),
                    description = description
                )
            )
        }
        ...
        greenChallenges.forEach { description ->
            challenges.add(
                Challenge(
                    ...
                    category = context.getString(R.string.category_green),
                    description = description
                )
            )
        }
        ...
        yellowChallenges.forEach { description ->
            challenges.add(
                Challenge(
                    ...
                    category = context.getString(R.string.category_yellow),
                    description = description
                )
            )
        }
